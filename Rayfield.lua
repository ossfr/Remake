...
local RayfieldLibrary = {
	...
	Theme = {
		Default = {
			...
			Topbar = Color3.fromRGB(50, 0, 0),
			Shadow = Color3.fromRGB(20, 20, 20),

			NotificationBackground = Color3.fromRGB(20, 20, 20),
			NotificationActionsBackground = Color3.fromRGB(230, 0, 0),

			TabBackground = Color3.fromRGB(40, 40, 40),
			TabStroke = Color3.fromRGB(60, 0, 0),
			TabBackgroundSelected = Color3.fromRGB(210, 0, 0),
			TabTextColor = Color3.fromRGB(240, 240, 240),
			SelectedTabTextColor = Color3.fromRGB(100, 0, 0),

			ElementBackground = Color3.fromRGB(35, 35, 35),
			ElementBackgroundHover = Color3.fromRGB(40, 40, 40),
			SecondaryElementBackground = Color3.fromRGB(25, 25, 25),
			ElementStroke = Color3.fromRGB(50, 0, 0),
			SecondaryElementStroke = Color3.fromRGB(40, 0, 0),

			SliderBackground = Color3.fromRGB(43, 0, 0),
			SliderProgress = Color3.fromRGB(43, 0, 0),
			SliderStroke = Color3.fromRGB(48, 0, 0),

			ToggleBackground = Color3.fromRGB(30, 30, 30),
			ToggleEnabled = Color3.fromRGB(255, 0, 0),
			ToggleDisabled = Color3.fromRGB(100, 100, 100),
			ToggleEnabledStroke = Color3.fromRGB(170, 0, 0),
			ToggleDisabledStroke = Color3.fromRGB(125, 125, 125),
			ToggleEnabledOuterStroke = Color3.fromRGB(100, 0, 0),
			ToggleDisabledOuterStroke = Color3.fromRGB(65, 0, 0),

			InputBackground = Color3.fromRGB(30, 30, 30),
			InputStroke = Color3.fromRGB(65, 0, 0),
		...
		Light = {
			...
			ElementBackground = Color3.fromRGB(198, 0, 0),
			ElementBackgroundHover = Color3.fromRGB(230, 0, 0),
			SecondaryElementBackground = Color3.fromRGB(136, 0, 0),
			...
			ToggleBackground = Color3.fromRGB(170, 0, 0),
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	if Settings.LoadingTitle ~= "Rayfield Interface Suite" then
		LoadingFrame.Version.Text = "OSS Hub #1 Script Hub"
	end
